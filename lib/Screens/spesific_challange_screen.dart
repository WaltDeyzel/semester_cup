...
class _SpesificChallengeScreen extends State<SpesificChallengeScreen> {
  ...
  Future<void> _addChallengeEntry() async {
    final imageFile = await ImagePicker.platform.pickImage(source: ImageSource.camera, maxWidth: 600);
  }

  @override
  Widget build(BuildContext context) {
    // Challenge challenge = ModalRoute.of(context).settings.arguments as Challenge;
    Challenge selectedChallenge = ModalRoute.of(context).settings.arguments as Challenge;
